function [PLV_Pairs_Scalp,nChannelPairs,freqAxis,dataBipolar_Scalp] = calculate_PLV_scalp_HL_P44(macro_data,data_Scalp_Session,Scalp_TrialInfoTable,...
...
%% Channel Pairs
nScalpChans = numel(dataBipolarScalp.label);

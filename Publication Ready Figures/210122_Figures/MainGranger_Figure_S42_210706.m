...
ind = find(PLV_maint_topo>(max(PLV_maint_topo) - max(PLV_maint_topo)*0.3))
...
ind = find(Granger_topo>(max(Granger_topo) - max(Granger_topo)*0.42))
elecColors = Granger_topo;
...
axes(ha(11));
ActualDistofSP = ScalarProduct.Actual;
RandomDistofSP =ScalarProduct.Random;
...
cbh.Label.Position = [2.936969540335916,0.000019073486328,0];
colormap(gca,cmap);
...
% Create textbox
annotation(fig,'textbox',...
    [0.338718671582143,0.9459,0.04908376856078,0.069387753642335],...
    'String',{'b'},...
    'FontSize',16,...
    'FontWeight','bold',...
    'FitBoxToText','off',...
...
% Create textbox
annotation(fig,'textbox',...
    [0.655929551720934,0.9473943810456,0.047774868076228,0.069387753642336],...
    'String',{'c'},...
    'FontSize',16,...
    'FontWeight','bold',...
    'EdgeColor','none');
...
% Create textbox
annotation(fig,'textbox',...
    [0.335798816568047,0.715366041325436,0.04908376856078,0.069387753642335],...
    'String',{'e'},...
    'FontSize',16,...
    'FontWeight','bold',...
    'FitBoxToText','off',...
...
% Create textbox
annotation(fig,'textbox',[0.658284023668641,0.715366041325436,0.04908376856078,0.069387753642335],...
    'String',{'f'},...
    'FontSize',16,...
    'FontWeight','bold',...
    'FitBoxToText','off',...
...
% Create textbox
annotation(fig,'textbox',[0.337278106508875,0.483924993290508,0.04908376856078,0.069387753642335],...
    'String',{'h'},...
    'FontSize',16,...
    'FontWeight','bold',...
    'FitBoxToText','off',...
...
% Create textbox
annotation(fig,'textbox',[0.653846153846155,0.482469389214817,0.04908376856078,0.069387753642335],...
    'String',{'i'},...
    'FontSize',16,...
    'FontWeight','bold',...
    'FitBoxToText','off',...
...
% Create textbox
annotation(fig,'textbox',[0.337278106508875,0.249572737104193,0.04908376856078,0.069387753642335],...
    'String',{'k'},...
    'FontSize',16,...
    'FitBoxToText','off',...
    'FontWeight','bold',...
...
% Create textbox
annotation(fig,'textbox',[0.653846153846155,0.248117133028502,0.04908376856078,0.069387753642335],...
    'String',{'l'},...
    'FontSize',16,...
    'FontWeight','bold',...
    'FitBoxToText','off',...

...
annotation(fig,'textbox',...
    ...
    'EdgeColor','none');
% Create textbox
h = text(4.120716094970703,8.048528571819167,0.237154126167283,'\DeltaGranger (%)')
...
print(fig,'F:\Vasileios\Task Analysis\Analysis Results\Results_for_Publication\Publication Ready Figure\Portrait Figs\BehaviourGranger\Behavioural_Granger_Fig_5','-dpdf','-r1000');
print(fig,'F:\Vasileios\Task Analysis\Analysis Results\Results_for_Publication\Publication Ready Figure\Portrait Figs\BehaviourGranger\Behavioural_Granger_Fig_5','-dpng','-r1000');
print(fig,'F:\Vasileios\Task Analysis\Analysis Results\Results_for_Publication\Publication Ready Figure\Portrait Figs\BehaviourGranger\Behavioural_Granger_Fig_5','-depsc','-r1000');
saveas(fig,'F:\Vasileios\Task Analysis\Analysis Results\Results_for_Publication\Publication Ready Figure\Portrait Figs\BehaviourGranger\Behavioural_Granger_Fig_5.fig');
saveas(fig,'F:\Vasileios\Task Analysis\Analysis Results\Results_for_Publication\Publication Ready Figure\Portrait Figs\BehaviourGranger\Behavioural_Granger_Fig_5.tif');

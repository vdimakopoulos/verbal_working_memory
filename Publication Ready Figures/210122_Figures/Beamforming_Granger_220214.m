...
cfg.atlas = atlas;
cfg.camlight       = 'no';
cfg.roi = atlas.tissuelabel(sort([temp_idx_AC; temp_idx;temp_idx_PPC;temp_idx_V1]));
cfg.inputcoord = 'mni';
...
text('Parent',ha(3),'Rotation',90,'String','\DeltaGranger (%)',...
    'Position',[-96.40530913262774,-142.2404479428574,-68.79255342826218],'FontSize',12);
...
h8 = text(-81.33891296184083,762.6855313994479,-418.8733779708209,['Encoding'])
set(h8,'Rotation',22,'FontSize',11);

h8 = text(-114.2500295119808,678.0028627713014,-431.0760365167025,['Maintenance'])
set(h8,'Rotation',22,'FontSize',11);


h8 = text(-172.616228811462,443.2131629763649,-418.8733784382139,['Encoding'])
set(h8,'Rotation',22,'FontSize',11);

h8 = text(-205.075471692503,360.1120390783167,-431.0760411023984,['Maintenance'])
set(h8,'Rotation',22,'FontSize',11);


h8 = text(-263.8935513866654,123.7407964748666,-418.8733741016131,['Encoding'])
set(h8,'Rotation',22,'FontSize',11);

h8 = text(-294.1185304423952,38.29066422035362,-427.0084870904921,['Maintenance'])
set(h8,'Rotation',22,'FontSize',11);
%% Save figure
set(gcf,'color','white');
